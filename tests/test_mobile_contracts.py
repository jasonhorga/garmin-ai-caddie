...
class MobileContractTests(unittest.TestCase):
    ...
    def test_ios_live_views_define_expected_controls(self) -> None:
        ...
        self.assertIn("if let bag = ClubBagStore.bag()", current_hole)
        self.assertIn("ClubSettingsView(clubProfiles: package.clubProfiles)", round_home)
    ...
    def test_watch_views_define_glance_and_quick_inputs(self) -> None:
        ...
        self.assertIn("iPhone online", hole_view)
        self.assertIn("Queue \\(queuedEventCount)", hole_view)

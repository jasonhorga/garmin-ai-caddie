...
class MobileContractTests(unittest.TestCase):
    ...
    def test_ios_prep_searches_directly_before_review(self) -> None:
        ...
        self.assertIn("replacingExisting:", _read_required_source(self, IOS_DIR / "AICaddieApp.swift"))
        self.assertIn("两段 9 洞组合暂不支持备战下载", _read_required_source(self, IOS_DIR / "AICaddieApp.swift"))

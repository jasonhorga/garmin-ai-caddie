...
describe('DataQualityPage', () => {
  it('renders data quality state and affected refs', () => {
    ...
    // finding labels render through the zh dictionary, never raw
    ...
    expect(screen.getByText('覆盖 1/3 33.3%')).toBeInTheDocument()
    ...
    expect(screen.getByText('几何覆盖')).toBeInTheDocument()
    expect(screen.getByText('缺失')).toHaveClass('quality-missing')
    expect(screen.getByText('0/45')).toBeInTheDocument()
    expect(screen.getByText('报告覆盖')).toBeInTheDocument()

...
describe('SettingsPage', () => {
  ...
  it('renders API-backed settings state when provided', () => {
    ...
    expect(within(screen.getByLabelText('OAuth 能力矩阵')).getByText('Golf scorecards: unproven')).toBeInTheDocument()
    expect(within(screen.getByLabelText('OAuth 能力矩阵')).getByText('Identity: possible')).toBeInTheDocument()

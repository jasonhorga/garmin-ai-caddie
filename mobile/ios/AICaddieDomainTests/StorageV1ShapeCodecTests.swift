...
final class StorageV1ShapeCodecTests: XCTestCase {
    ...
    private func exerciseRepresentativeRoot(using decode: Decode) throws {
        try activity(
    ...
    private func exerciseRoundKindAndTerminalStatuses(using decode: Decode) throws {
        try activity(
    ...
    private func exerciseNFCForDynamicKeysAndValues(using decode: Decode) throws {
        try activity(
    ...
    private func exerciseOrdinaryStringScalarBounds(using decode: Decode) throws {
        try activity(
    ...
    private func exercisePreparedSlotBounds(using decode: Decode) throws {
        try activity(
    ...
    private func exerciseBase64CanonicalFormAndBounds(using decode: Decode) throws {
        try activity(
    ...
    private func exerciseIntegerAndDoubleLexicalRoutes(using decode: Decode) throws {
        try activity(

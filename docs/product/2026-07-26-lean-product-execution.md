...
| IOS-07 | `OPEN / 真实长名称已复现` | [Native run 30590307902](https://github.com/jasonhorga/garmin-ai-caddie/actions/runs/30590307902) 的真实首页把 `Cypress Point Club` 在“上一场”卡片中挤成四行单词塔；缩略图、日期与成绩共同侵占标题宽度。短中文球场名没有暴露该问题，不能据此判定首页布局已完成。当前先关闭 Live Hole 透明 topo，随后把这项作为下一处确定的结构性偏差处理。 |

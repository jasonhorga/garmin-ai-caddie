...
### Additional Dynamic Backfill Near Seventy Percent Coverage

Ran one more bounded local batch with the same current-release preflight. This continued the played-shot, hole-level geometry coverage backfill; it should not be read as evidence that the earlier CourseView download pass failed, because the current coverage metric requires both meshes and hazards for every actually played `globalId + localHole` pair.

- Batch 20: 75 attempted, 75 downloaded, 0 failed.
- Preflight skipped 36 dependencies before selection:
  - `release_missing_hole`: 18
  - `release_unavailable`: 18
- `release_unavailable` remained concentrated on `31636` and `31637`.
...
```json
{
  ...
  "partialPairs": 0,
  "missingPairs": 453,
  "coverage": {"ready": 1048, "total": 1501, "pct": 69.8},
  "completePlayedCourseCount": 33,
  "completePlayedGlobalIds": [31794, 41825, 31796, 31795, 39315, 39270, 31692, 40590, 31702, 31793, 39668, 31777, 31791, 31792, 31789, 39592, 31835, 46249, 31779, 31751, 31778, 31829, 31833, 31810, 31834, 31688, 31596, 31687, 31790, 31597, 31806, 31805, 31827]
}
```
...
```json
{
  "31835": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 162},
  "31779": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 155},
  "31751": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 154},
  "31810": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 124},
  "31688": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 111},
  "31687": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 94},
  "31790": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 93}
}
```
...
```json
{
  ...
  "31927": {"playedPairs": 17, "readyPairs": 1, "missingPairs": 16},
  "38402": {"playedPairs": 18, "readyPairs": 4, "missingPairs": 14},
  "31878": {"playedPairs": 17, "readyPairs": 4, "missingPairs": 13}
}
```
...
```text
data/courseview/prodgeometry  754M
output/prodgeometry           2.3G
output/prodgeometry_hazards   192M
```
...
### Additional Dynamic Backfill Near Eighty Percent Coverage

Ran one more bounded local batch with the same current-release preflight.

- Batch 22: 75 attempted, 75 downloaded, 0 failed.
- Preflight skipped 36 dependencies before selection:
  - `release_missing_hole`: 18
  - `release_unavailable`: 18
- `release_unavailable` remained concentrated on `31636` and `31637`.
...
```json
{
  ...
  "partialPairs": 0,
  "missingPairs": 303,
  "coverage": {"ready": 1198, "total": 1501, "pct": 79.8},
  "completePlayedCourseCount": 40,
  "completePlayedGlobalIds": [31794, 41825, 31796, 31795, 39315, 39270, 31692, 40590, 31702, 31793, 39668, 31777, 31791, 31792, 31789, 32871, 39592, 31835, 46249, 31779, 32870, 31751, 31778, 31829, 31833, 31810, 31834, 31688, 31596, 31687, 31790, 31597, 31594, 2625, 6997, 31806, 39546, 31805, 31827, 31598]
}
```
...
```json
{
  "31594": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 62},
  "2625": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 58},
  "6997": {"playedPairs": 17, "readyPairs": 17, "missingPairs": 0, "shotCount": 57},
  "39546": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 53},
  "31598": {"playedPairs": 7, "readyPairs": 7, "missingPairs": 0, "shotCount": 24}
}
```
...
```json
{
  ...
  "31636": {"playedPairs": 9, "readyPairs": 0, "missingPairs": 9},
  "31637": {"playedPairs": 9, "readyPairs": 0, "missingPairs": 9},
  "31927": {"playedPairs": 17, "readyPairs": 5, "missingPairs": 12},
  "39643": {"playedPairs": 18, "readyPairs": 8, "missingPairs": 10},
  "38402": {"playedPairs": 18, "readyPairs": 10, "missingPairs": 8},
  "38404": {"playedPairs": 18, "readyPairs": 9, "missingPairs": 9}
}
```
...
```text
data/courseview/prodgeometry  846M
output/prodgeometry           2.5G
output/prodgeometry_hazards   214M
```
...
### Additional Dynamic Backfill Past Eighty Percent Coverage

Ran one more bounded local batch with the same current-release preflight. One selected row hit a transient HTTP 502 during the batch and succeeded on an immediate single-row retry, so the final landed geometry result is counted as fully downloaded.

- Batch 23: 75 selected, 74 downloaded during the batch, 1 transient failed, 1 retry downloaded.
- Final landed result: 75 downloaded, 0 remaining failed from this batch.
- Preflight skipped 36 dependencies before selection:
  - `release_missing_hole`: 18
  - `release_unavailable`: 18
- `release_unavailable` remained concentrated on `31636` and `31637`.
- Transient retry evidence: `31676 h8` initially returned HTTP 502, then `ensure_prodgeometry(31676, 8)` succeeded with meshes, distances, and hazards.
...
```json
{
  ...
  "partialPairs": 0,
  "missingPairs": 228,
  "coverage": {"ready": 1273, "total": 1501, "pct": 84.8},
  "completePlayedCourseCount": 48,
  "completePlayedGlobalIds": [31794, 41825, 31796, 31795, 39315, 39270, 31692, 40590, 31702, 31793, 39668, 31777, 31791, 31792, 31789, 32871, 39592, 31835, 46249, 31779, 32870, 31751, 31778, 31829, 31833, 31810, 31834, 31682, 31688, 31596, 31787, 31687, 31790, 31877, 31597, 31594, 2625, 6997, 31806, 31695, 39546, 31826, 31805, 31827, 31832, 31828, 31679, 31598]
}
```
...
```json
{
  "31682": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 113},
  "31787": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 108},
  "31877": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 92},
  "31695": {"playedPairs": 17, "readyPairs": 17, "missingPairs": 0, "shotCount": 54},
  "31826": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 52},
  "31832": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 49},
  "31828": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 32},
  "31679": {"playedPairs": 8, "readyPairs": 8, "missingPairs": 0, "shotCount": 26}
}
```
...
```text
data/courseview/prodgeometry  889M
output/prodgeometry           2.7G
output/prodgeometry_hazards   224M
```
...
### Additional Dynamic Backfill Near Ninety Percent Coverage

Ran one more bounded local batch with the same current-release preflight.

- Batch 24: 75 attempted, 75 downloaded, 0 failed.
- Preflight skipped 36 dependencies before selection:
  - `release_missing_hole`: 18
  - `release_unavailable`: 18
- `release_unavailable` remained concentrated on `31636` and `31637`.
...
```json
{
  ...
  "partialPairs": 0,
  "missingPairs": 153,
  "coverage": {"ready": 1348, "total": 1501, "pct": 89.8},
  "completePlayedCourseCount": 54,
  "completePlayedGlobalIds": [31794, 41825, 31796, 31795, 39315, 39270, 31692, 40590, 31702, 31793, 39668, 31777, 31791, 31792, 31789, 32871, 39592, 31835, 46249, 31779, 32870, 31751, 31778, 39293, 31829, 31833, 31810, 31834, 31682, 31688, 31596, 31787, 32859, 31687, 31790, 31877, 39247, 31926, 31929, 31597, 31594, 38642, 2625, 6997, 31806, 31695, 39546, 31826, 31805, 31827, 31832, 31828, 31679, 31598]
}
```
...
```json
{
  "39293": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 143},
  "32859": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 102},
  "39247": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 90},
  "31926": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 89},
  "31929": {"playedPairs": 17, "readyPairs": 17, "missingPairs": 0, "shotCount": 85},
  "38642": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 62}
}
```
...
```json
{
  ...
  "31637": {"playedPairs": 9, "readyPairs": 0, "missingPairs": 9},
  "39643": {"playedPairs": 18, "readyPairs": 8, "missingPairs": 10},
  "41319": {"playedPairs": 18, "readyPairs": 10, "missingPairs": 8},
  "39615": {"playedPairs": 18, "readyPairs": 12, "missingPairs": 6},
  "42707": {"playedPairs": 18, "readyPairs": 13, "missingPairs": 5}
}
```
...
```text
data/courseview/prodgeometry  931M
output/prodgeometry           2.8G
output/prodgeometry_hazards   233M
```
...
### Additional Dynamic Backfill Past Ninety Percent Coverage

Ran one more bounded local batch with the same current-release preflight.

- Batch 25: 75 attempted, 75 downloaded, 0 failed.
- Preflight skipped 36 dependencies before selection:
  - `release_missing_hole`: 18
  - `release_unavailable`: 18
- `release_unavailable` remained concentrated on `31636` and `31637`.
...
```json
{
  ...
  "partialPairs": 0,
  "missingPairs": 78,
  "coverage": {"ready": 1423, "total": 1501, "pct": 94.8},
  "completePlayedCourseCount": 73
}
```
...
```json
{
  "39659": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 121},
  "42707": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 90},
  "31761": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 62},
  "31610": {"playedPairs": 17, "readyPairs": 17, "missingPairs": 0, "shotCount": 55},
  "31744": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 52},
  "39660": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 52},
  "30250": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 51},
  "31669": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 51},
  "31800": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 51},
  "30249": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 50},
  "30253": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 48},
  "31673": {"playedPairs": 18, "readyPairs": 18, "missingPairs": 0, "shotCount": 48},
  "31801": {"playedPairs": 17, "readyPairs": 17, "missingPairs": 0, "shotCount": 48},
  "31676": {"playedPairs": 17, "readyPairs": 17, "missingPairs": 0, "shotCount": 45},
  "31763": {"playedPairs": 12, "readyPairs": 12, "missingPairs": 0, "shotCount": 40},
  "31678": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 25},
  "39651": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 22},
  "31821": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 21},
  "31822": {"playedPairs": 9, "readyPairs": 9, "missingPairs": 0, "shotCount": 20}
}
```
...
```json
{
  ...
  "31636": {"playedPairs": 9, "readyPairs": 0, "missingPairs": 9},
  "31637": {"playedPairs": 9, "readyPairs": 0, "missingPairs": 9},
  "31918": {"playedPairs": 18, "readyPairs": 14, "missingPairs": 4},
  "38404": {"playedPairs": 18, "readyPairs": 14, "missingPairs": 4},
  "31920": {"playedPairs": 18, "readyPairs": 15, "missingPairs": 3},
  "42936": {"playedPairs": 17, "readyPairs": 14, "missingPairs": 3}
}
```
...
```text
data/courseview/prodgeometry  972M
output/prodgeometry           2.9G
output/prodgeometry_hazards   241M
```
